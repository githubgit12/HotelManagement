...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
 ...
 <script type="text/javascript">
   function addfunction(){
     parent.document.getElementById('Mainid').src='${ctx}/Team/toadd.do?teamName='+'${txtname}';
   }
   ...
   var chk_value=[];
  	...
  	if(chk_value!=""){
		if(chk_value.toString().indexOf(",")>0){
		   ...
		   parent.document.getElementById("Mainid").src='${ctx}/Team/toupdate.do?id='+chk_value;
		}
	}else{
	  alert("请选择一条数据进行修改");
	}
   ...
   var chk_value=[];
     ...
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/Team/delete.do?id='+chk_value;
  	}
  	}else{
  ...
  $(".tcdPageCode").createPage({
     ...
     location.href="${ctx}/Team/teamMembers.do?currentPage="+p+"&txtname="+txtname;
     }
   });
