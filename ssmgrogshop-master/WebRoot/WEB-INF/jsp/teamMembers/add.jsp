...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <form action="${ctx}/Team/add.do?teamName=${teamName}" method="post" onsubmit="return verify()">
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
		     ...
		     <div class="span3">
		        <label>性别：</label>
		        <input id="nameId" name="sex" type="text" style="width:97%;height:27px;float:left;" onchange="onchangeOne()">
		     </div>
	   ...
	   <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
		        <label>联系电话：</label>
		         <input id="contactPhoneNumberId" name="phoneNumber" type="text" 
